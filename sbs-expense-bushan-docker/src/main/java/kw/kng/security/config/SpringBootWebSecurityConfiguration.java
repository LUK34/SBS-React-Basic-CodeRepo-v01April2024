...
import kw.kng.security.service.JwtRequestFilter;
...
public class SpringBootWebSecurityConfiguration 
{
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
        	...
        	/*	
         	...
         	The above piece of code we are telling to spring security to not maintain any session. 
          	Becuase we are maintaning the session to be stateless for JWT.
	...
	@Bean //We are creating an instance of the custom filter
